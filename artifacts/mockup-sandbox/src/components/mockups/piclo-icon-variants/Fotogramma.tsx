      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
        ...
        >
          <svg viewBox="0 0 100 100" width="72" height="72">
            <rect x="18" y="18" width="64" height="64" rx="6" fill="none" stroke="white" strokeWidth="5" />
            <rect x="18" y="18" width="14" height="14" rx="2" fill="none" stroke="white" strokeWidth="3" />
            <rect x="68" y="18" width="14" height="14" rx="2" fill="none" stroke="white" strokeWidth="3" />
            <rect x="18" y="68" width="14" height="14" rx="2" fill="none" stroke="white" strokeWidth="3" />
            <rect x="68" y="68" width="14" height="14" rx="2" fill="none" stroke="white" strokeWidth="3" />
            <circle cx="65" cy="35" r="6" fill="white" />
            <circle cx="65" cy="35" r="3" fill="rgba(139,92,246,0.7)" />
          </svg>
        </div>

        <svg viewBox="52 40 498 216" width="180" height="78" style={{ display: "block" }}>
          <defs>
            <linearGradient id="foto-text-grad" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          {PICLO_PATHS.map((d, i) => (
            <path key={i} d={d} fill="url(#foto-text-grad)" />
          ))}
        </svg>

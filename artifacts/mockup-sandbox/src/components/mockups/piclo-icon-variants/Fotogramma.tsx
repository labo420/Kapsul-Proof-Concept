export function Fotogramma() {
  const paths = [
    ...
    "M417.36 43.84L417.36 208.24Q417.36 210.40 392.88 210.40L392.88 210.40Q373.68 210.16 373.68 208.48L373.68 208.48L373.68 45.04Q373.68 41.44 396.96 41.44L396.96 41.44Q417.36 42.16 417.36 43.84L417.36 43.84Z",
  ...
  // Frame bounds: x=628..712, y=80..216
  const fx = 628, fy = 80, fw = 84, fh = 136;
  const cs = 14; // corner mark size
  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 730 296" style={{ width: "90%", maxWidth: 660 }}>
        ...
        {/* Frame outer rect */}
        <rect x={fx} y={fy} width={fw} height={fh} rx={5} fill="none" stroke="white" strokeWidth={4} opacity={0.9} />

        {/* Corner marks — inner notches */}
        {/* top-left */}
        <line x1={fx} y1={fy + cs} x2={fx} y2={fy} stroke="white" strokeWidth={6} strokeLinecap="square" />
        <line x1={fx} y1={fy} x2={fx + cs} y2={fy} stroke="white" strokeWidth={6} strokeLinecap="square" />
        {/* top-right */}
        <line x1={fx + fw} y1={fy + cs} x2={fx + fw} y2={fy} stroke="white" strokeWidth={6} strokeLinecap="square" />
        <line x1={fx + fw} y1={fy} x2={fx + fw - cs} y2={fy} stroke="white" strokeWidth={6} strokeLinecap="square" />
        {/* bottom-left */}
        <line x1={fx} y1={fy + fh - cs} x2={fx} y2={fy + fh} stroke="white" strokeWidth={6} strokeLinecap="square" />
        <line x1={fx} y1={fy + fh} x2={fx + cs} y2={fy + fh} stroke="white" strokeWidth={6} strokeLinecap="square" />
        {/* bottom-right */}
        <line x1={fx + fw} y1={fy + fh - cs} x2={fx + fw} y2={fy + fh} stroke="white" strokeWidth={6} strokeLinecap="square" />
        <line x1={fx + fw} y1={fy + fh} x2={fx + fw - cs} y2={fy + fh} stroke="white" strokeWidth={6} strokeLinecap="square" />

      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
        ...
        >
          <svg viewBox="0 0 100 100" width="72" height="72">
            <defs>
              <radialGradient id="obj-center" cx="50%" cy="50%" r="50%">
            ...
            {blades.map((i) => (
              <ellipse
                ...
                transform={`rotate(${i * 60} 50 50) translate(0 -12)`}
                style={{ transformOrigin: "50px 50px" }}
              />
            ))}
            <circle cx="50" cy="50" r="12" fill="white" />
            <circle cx="50" cy="50" r="7" fill="url(#obj-center)" stroke="rgba(0,0,0,0.2)" strokeWidth="1" />
          </svg>
        </div>

        <svg viewBox="52 40 498 216" width="180" height="78" style={{ display: "block" }}>
          <defs>
            <linearGradient id="obj-text-grad" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          {PICLO_PATHS.map((d, i) => (
            <path key={i} d={d} fill="url(#obj-text-grad)" />
          ))}
        </svg>

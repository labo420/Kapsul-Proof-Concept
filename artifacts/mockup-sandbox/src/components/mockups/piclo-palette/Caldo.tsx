  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-zinc-950">
      <div
        ...
        style={{ width: 390, height: 844, background: "#0A0009", border: "1px solid rgba(255,255,255,0.08)" }}
      >
        {/* Status bar */}
        ...
        <div className="absolute bottom-0 left-0 right-0 h-48" style={{ background: "linear-gradient(to top, #0A0009 40%, transparent)" }} />

        {/* Tab bar */}
        <div
          className="absolute bottom-0 left-0 right-0 pb-6 pt-3 flex justify-around items-center"
          style={{ background: "rgba(10,0,9,0.9)", backdropFilter: "blur(20px)", borderTop: "1px solid rgba(255,255,255,0.06)" }}
        >
          {[
